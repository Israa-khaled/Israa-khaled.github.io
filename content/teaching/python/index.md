...
We define the normalized inter-user spatial interference metric {{< math >}}$$ \beta_{k,u} $$ {{< /math >}} in a mono-path environment as follows:
...
where {{< math >}}$$ \mathbf{a}_{1,u} $$ {{< /math >}} is the array steering vector of the beam generated toward UE {{< math >}}$$ u $$ {{< /math >}} spatial direction, i.e., {{< math >}}$$ \vec{\Theta}_{1,u} $$ {{< /math >}}, and {{< math >}}$$ \mathbf{a}^H_{1,k} $$ {{< /math >}} is the array steering vector of the LoS path in UE {{< math >}}$$ k $$ {{< /math >}} channel. Thus, {{< math >}}$$ \beta_{k,u} $$ {{< /math >}} is the normalized spatial interference of the beam generated toward UE {{< math >}}$$ u $$ {{< /math >}} with the LoS path in UE {{< math >}}$$ k $$ {{< /math >}} channel.
...
![Normalized array factor](pattern_beta.pdf)  
...
![First side lobe](pattern_beta.pdf)  
